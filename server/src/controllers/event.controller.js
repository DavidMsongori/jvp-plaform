...
export const incrementViews = async (req, res, next) => {
  try {
    await eventService.incrementViews(req.params.id);
...
export const incrementShares = async (req, res, next) => {
  try {
    await eventService.incrementShares(req.params.id);
...
export const incrementBookmarks = async (
  req,
  res,
  next
) => {
  try {
    await eventService.incrementBookmarks(req.params.id);
...
export const incrementImpressions = async (
  ...
  try {
    await eventService.incrementImpressions(req.params.id);
